...
public class Button extends JButton {
	...
	/*
	 * public Button() { setBorder(new EmptyBorder(10, 12, 15, 12));
	 * setContentAreaFilled(false); setBackground(new Color(255, 255, 255));
	 * setForeground(new Color(80, 80, 80)); rippleEffect.setRippleColor(new
	 * Color(220, 220, 220)); }
	 */
    ...
    public Button(String text) {
        ...
        setBackground(new Color(212, 163, 115));
