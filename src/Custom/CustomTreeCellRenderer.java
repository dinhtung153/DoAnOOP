...
public class CustomTreeCellRenderer extends DefaultTreeCellRenderer {
    ...
    public Component getTreeCellRendererComponent(JTree tree, Object value,
        ...
        Person person = FamilyTreeModel.people.get(node.getUserObject());
        
        // Set the appropriate icon for the user object
         if (person.isMale()) {
            setIcon(new ImageIcon("man.png"));
        } else if (!person.isMale()) {
            setIcon(new ImageIcon("./woman.png"));
        } else if (person.isMale() && leaf) {
            setIcon(new ImageIcon("./boy.png"));
        } else if (!person.isMale() && leaf) {
            setIcon(new ImageIcon("./girl.png"));
        }
        this.setLeafIcon(new ImageIcon("boy.png"));
        if (leaf) {
            setIcon(new ImageIcon("boy.png"));
        }
        ...
        // Thiết lập các thuộc tính cho khung của nút
        setBorder(null);
        return this;
        
    }
    
//    public TreeCellStyle getStyle() {
//        return style;
//    }
//
//    public void setStyle(TreeCellStyle style) {
//        if (this.style != style) {
//            this.style = style;
//            animationHover.stop();
//            animationPress.stop();
...
//    private TreeCellStyle style = TreeCellStyle.PRIMARY;
//    private TreeCellColor currentStyle = new TreeCellColor(TreeCellStyle.PRIMARY);
//    private int round = 5;
//
...
//        Area area = new Area(new RoundRectangle2D.Double(x, y, width, height, round + 5, round + 5));
...
//
//        private TreeCellStyle(Color background, Color foreground, Color backgroundHover, Color backgroundPress) {
...
//        }
//
//        public TreeCellColor(TreeCellStyle style) {
//            changeStyle(style);
//        }
//
//        public TreeCellColor() {
//        }
//
//        private Color background;
//        private Color foreground;
...
//        private Color backgroundPress;
//
//        private void changeStyle(TreeCellStyle style) {
...
//        private final TreeCellColor style;
//        private final String property;
//        private TimingTarget target;
//
//        public AnimationStyle(int duration, TreeCellColor style, String property) {
//            this.style = style;
